...
public class clientUI extends JFrame {
	...
	JLabel FirstPanelLabelImage = new JLabel(
			new ImageIcon("/Users/chencong/Downloads/Java-master/project/MovieSystem/picture/1.png"));
	...
	JLabel ThirdPanelUserHeadImage = new JLabel(
			new ImageIcon("/home/kiosk/IdeaProjects/Practice/src/MovieSystem/picture/head1.png"));
	...
	public void init() {
		...
		clientMoviePanel film2 = new clientMoviePanel("饥饿游戏",
				"/Users/chencong/Downloads/Java-master/project/MovieSystem/picture/film2.png");
		clientMoviePanel film3 = new clientMoviePanel("听风者",
				"/Users/chencong/Downloads/Java-master/project/MovieSystem/picture/film3.png");
		clientMoviePanel film4 = new clientMoviePanel("复仇者联盟",
				"/Users/chencong/Downloads/Java-master/project/MovieSystem/picture/film4.png");
		clientMoviePanel film5 = new clientMoviePanel("泰坦尼克号",
				"/Users/chencong/Downloads/Java-master/project/MovieSystem/picture/film5.png");
		clientMoviePanel film6 = new clientMoviePanel("师父",
				"/Users/chencong/Downloads/Java-master/project/MovieSystem/picture/film6.png");
	...
	class MyButtonActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			clickButton = (JButton) e.getSource();
			if (clickButton == FirstPanelButton1 || clickButton == SecondPanelViewFilmButton
					|| clickButton == ThirdPanelViewFilmButton || clickButton == FourthPanelViewFilmButton) {
				card.first(cardPanel);
				for (int i = 0; i < 1; i++) {
					card.next(cardPanel);
				}
				repaint();
			} else if (clickButton == SecondPanelChangePasswdButton || clickButton == ThirdPanelChangePasswdButton
				...
				repaint();
			} else if (clickButton == SecondPanelRechargeButton || clickButton == ThirdPanelRechargeButton
				 ...
				 * else if(clickButton == rightBut6) { card.first(cardPanel); for (int i = 0; i
				 * < 5; i++) { card.next(cardPanel); } repaint(); } else if(clickButton ==
				 * rightBut7) { card.first(cardPanel); for (int i = 0; i < 6; i++) {
				 * card.next(cardPanel); } }
				 */
		}
	}
